...
<body>
    <div>
        <h1 class="titulo2">Crea tu cuenta </h1>
    </div>
    ...
    <main class="formularios">
        <form action="Insertar.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="password" class="form-control" id="edad" placeholder="ingresa tu edad" name="edad">
            </div>
            <div class="mb-3 mt-3">
                <label for="email" class="form-label">informacion suya:</label>
                <input type="text" class="form-control" id="informacion" placeholder="Ingresa informacion" name="informacion">
            </div>
            <!--imagen-->
            <div class="mb-3">
